...
import useStyles from "../Styles/forgotPasswordEmail";
import { getIsMobile } from "../utils";
import EmailForm from "../components/AuthComponent/email";
import { useRouter } from "next/router";

interface Props {}

const ForgotPasswordEmail: NextPage<Props> = ({}) => {
  ...
  const renderTabs = () => {
    return (
      <div className={classes.tabContainer}>
        <div className={classes.activeTab}>Email</div>
        <div
          className={classes.inactiveTab}
          onClick={() => {
            router.push("/forgot-password-mobile");
          }}
        >
          Mobile
        </div>
