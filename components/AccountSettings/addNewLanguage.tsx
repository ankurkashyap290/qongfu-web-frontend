...
const AddNewLanguage: FunctionComponent<Props> = ({
  addMissingEntity,
  profile,
  loading,
  dialogInfo,
  ...
  const validationSchema = () => {
    return Yup.object().shape({
      content: Yup.string().required("* Language is required"),
    });
  };
            ...
            <Form onSubmit={handleSubmit}>
              <div className={classes.addNewModalContent}>
                ...
                <Typography variant="body1" className={classes.modalDesc}>
                  If you weren’t able to find your Language, you’ve come to the right place!
                </Typography>
                <TextField
                  id="content"
...
export default connect(mapStateToProps, mapDispatchToProps)(AddNewLanguage);
